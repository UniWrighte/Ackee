...
export const SET_DOMAINS_VALUE = window.Symbol()
export const SET_DOMAINS_FETCHING = window.Symbol()
export const SET_DOMAINS_ERROR = window.Symbol()
export const RESET_DOMAINS = window.Symbol()
