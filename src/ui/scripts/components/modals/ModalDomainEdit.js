...
const ModalDomainEdit = (props) => {
  ...
  const deleteDomain = (e) => {
    e.preventDefault()
    const c = window.confirm(`Are you sure you want to delete the domain "${props.title}"? This action cannot be undone.`)
  ...
  const srcUrl = (new URL('/tracker.js', window.location.href)).href
